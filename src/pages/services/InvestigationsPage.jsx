...
import {
  ShieldCheck, Scale, Briefcase, CheckCircle2, Quote, Building2, TrendingUp, UserCheck, Eye, ClipboardCheck, ShieldAlert, Globe, Mail, Phone,
} from "lucide-react";
...
function HeroVisual() {
  return (
    <ServiceHeroVisual
      ...
      label="Illustration: link-analysis map connecting people, places and records"
      Icon={Eye}
    />
  );
}
    ...
    <div className="fa-root">
      ...
      <header className="fa-hero">
        ...
        <p className="fa-subhead-oneline">
          {iv.heroTitle1} {iv.heroTitle2}<em>{iv.heroTitle3}</em>{iv.heroTitle4}
        </p>
        <p className="lede">
          {iv.heroLede}
        </p>
