...
import {
  ShieldCheck, Scale, Gavel, Landmark, Briefcase, CheckCircle2, Quote, Building2, FileWarning, PenTool, FileClock, Printer, FolderCheck, Stamp, Mail, Phone,
} from "lucide-react";
...
function HeroVisual() {
  return (
    <ServiceHeroVisual
      variant="document"
      label="Illustration: document with signature under a magnifying lens"
      Icon={Stamp}
    />
  );
}
    ...
    <div className="fa-root">
      ...
      <header className="fa-hero">
        ...
        <p className="fa-subhead-oneline">
          {de.heroTitle1} {de.heroTitle2}<em>{de.heroTitle3}</em>{de.heroTitle4}
        </p>
        <p className="lede">
          {de.heroLede}
        </p>
