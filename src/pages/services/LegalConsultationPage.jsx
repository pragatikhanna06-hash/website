...
import {
  Scale, Gavel, FileSearch, FileText, BookOpen, Landmark, Briefcase, CheckCircle2, Quote, Building2, Mail, Phone,
} from "lucide-react";
    ...
    <div className="fa-root">
      ...
      <header className="fa-hero">
        ...
        <p className="fa-subhead-oneline">
          {lc.heroTitle1} {lc.heroTitle2}<em>{lc.heroTitle3}</em>{lc.heroTitle4} {lc.heroTitle5}
        </p>
        <p className="lede">
          {lc.heroLede}
        </p>
