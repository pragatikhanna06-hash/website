...
import {
  ShieldCheck, Scale, Gavel, Briefcase, CheckCircle2, Mail, Quote, Building2, Monitor, Smartphone, Video, UserCheck, Phone,
} from "lucide-react";
    ...
    <div className="fa-root">
      ...
      <header className="fa-hero">
        ...
        <p className="fa-subhead-oneline">
          {df.heroTitle1} {df.heroTitle2}<em>{df.heroTitle3}</em>{df.heroTitle4}
        </p>
        <p className="lede">
          {df.heroLede}
        </p>
