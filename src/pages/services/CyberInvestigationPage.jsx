...
import {
  ShieldCheck, Scale, Landmark, CheckCircle2, Quote, Building2, Banknote, FileWarning, ShieldAlert, Bug, Radar as RadarIcon, Network, FileClock, ChevronDown, Siren, Mail, Phone,
} from "lucide-react";
...
function HeroVisual() {
  return (
    <ServiceHeroVisual
      variant="cyber"
      label="Illustration: security terminal, alert and attack-path map"
      Icon={ShieldAlert}
    />
  );
}
    ...
    <div className="fa-root">
      ...
      <header className="fa-hero">
        ...
        <p className="fa-subhead-oneline">
          {ci.heroTitle1} {ci.heroTitle2}<em>{ci.heroTitle3}</em>{ci.heroTitle4}
        </p>
        <p className="lede">
          {ci.heroLede}
        </p>
