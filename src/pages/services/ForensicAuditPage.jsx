...
import {
  ShieldCheck, Search, Landmark, Briefcase, CheckCircle2, Quote, Building2, TrendingUp, FileCheck2, Mail, Phone,
} from "lucide-react";
...
function HeroVisual() {
  return (
    <ServiceHeroVisual
      variant="forensic-audit"
      label="Illustration: ledger with flagged entries under a magnifying lens"
      Icon={Search}
    />
  );
}
    ...
    <div className="fa-root">
      ...
      <header className="fa-hero">
        ...
        <p className="fa-subhead-oneline">
          {fa.heroTitle1} {fa.heroTitle2}<em>{fa.heroTitle3}</em>{fa.heroTitle4}
        </p>
        <p className="lede">
          {fa.heroLede}
        </p>
